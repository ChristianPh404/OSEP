...
\nt{Las membranas usan transferencia de materia}

\mlenma{}{Fuerzas impulsoras de la transferencia de materia: Gradiente de concentración, Presión, Temperatura, Campos de fuerza....}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
%*                                    Insertar dibujo de transferencia de materia
\end{raggedright}
...
\begin{equation*}
	Ni = %*                                    Insertar ecuacion
\end{equation*}
de donde sale la siguiente ecuación 
\begin{equation*}
	N = \frac{ni}{A} %! 2 ecuacion diapositvas insertar.
\end{equation*}
\begin{equation*}
...
%*                                                   Insertar ecuaciones de la diapositiva + dibujo fraccion molar/distancia 
\nt{Para mezclas binarias como c = cte $\rightarrow$ D$_{A,B}$ = D$_{B,A}$}
\end{raggedright}
...
\begin{raggedright}
	...
	\end{equation*}
	\begin{equation*}
		NA = x_A \cdot N  %! Insertar formula respecto de conversion 1-xa
	\end{equation*}
...
%*                                    Insertar ecuacion de la diapositiva y imagenes 
\end{raggedright}


% \textbf{J, Densidad de flujo referiad a la velocidad media molar de la mezcla:} %*Revisar donde va 
\end{raggedright}
%! ----------------------------------------------------------------------------------------------------------
%!                                            PROBLEMAS 
%! ----------------------------------------------------------------------------------------------------------
